...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_js_multiPanel_multiPanel__ = __webpack_require__(37);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_kompo_util__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_kompo_util___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_kompo_util__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__css_multiPanel_css__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__css_multiPanel_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__css_multiPanel_css__);
/* unused harmony export slideTo */
...
var multiPanel = __WEBPACK_IMPORTED_MODULE_0_kompo___default.a.construct('div', function (_ref) {
    ...
    var classNames = _ref.classNames;
    var overlay = _ref.overlay;
    var defaultPanel = _ref.defaultPanel;
    var unit = _ref.unit;
...
function slideTo(multiPanel, panels, index) {
    var translateToAbsolute = 0;

    var mpProps = getProps(multiPanel);
    ...
    for (var _i = 0, _l = panels.length; _i < _l; ++_i) {
        if (_i === index) {
            panels[_i].classList.add('o-MultiPanel-panel--selected');
        } else {
            panels[_i].classList.remove('o-MultiPanel-panel--selected');
        }
    }

    // Factor into percentages
    var translateTo = translateToAbsolute / mpProps.totalWidth * 100;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_kompo__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_kompo___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_kompo__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_leaf__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_branch__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_js_multiPanel_panel__ = __webpack_require__(33);
