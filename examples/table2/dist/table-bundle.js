...
/* harmony default export */ __webpack_exports__["a"] = (__WEBPACK_IMPORTED_MODULE_0_kompo___default.a.construct('tr', function (_ref) {
    ...
    var defaultClass = _ref.defaultClass,
        ...
        hasColumnFilter = _ref.hasColumnFilter,
        columnFilter = _ref.columnFilter;
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return tableActions; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_kompo__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_kompo___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_kompo__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_kompo_util__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_kompo_util___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_kompo_util__);
...
/* harmony default export */ __webpack_exports__["a"] = (__WEBPACK_IMPORTED_MODULE_0_kompo___default.a.construct('table', function (_ref) {
    ...
    var appendRow = _ref.appendRow,
        ...
        oddRowClass = _ref.oddRowClass,
        evenRowClass = _ref.evenRowClass,
        selectedClass = _ref.selectedClass,
        appendHead = _ref.appendHead,
        headRowClass = _ref.headRowClass,
    ...
    appendRow: function appendRow(table, frag, key, props) {
        ...
        __WEBPACK_IMPORTED_MODULE_0_kompo___default.a.mount(table, tr, function (s) {
            var data = table.kompo.selector ? table.kompo.selector(s).data : s.data;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_kompo_util__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_kompo_util___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_kompo_util__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__table__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__tableRow__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__accordionTableRow__ = __webpack_require__(65);
...
/* harmony default export */ __webpack_exports__["a"] = (__WEBPACK_IMPORTED_MODULE_0_kompo___default.a.compose(__WEBPACK_IMPORTED_MODULE_2__table__["a" /* default */], {
    ...
    appendRow: function appendRow(table, frag, key, props) {
        ...
        __WEBPACK_IMPORTED_MODULE_0_kompo___default.a.mount(table, tr, selector);
        __WEBPACK_IMPORTED_MODULE_0_kompo___default.a.mount(table, contentTr, selector);
        frag.appendChild(tr);
...
/* harmony default export */ __webpack_exports__["a"] = (__WEBPACK_IMPORTED_MODULE_0_kompo___default.a.compose(__WEBPACK_IMPORTED_MODULE_2__table__["a" /* default */], {
    on: function on(table) {
        var tableProps = __WEBPACK_IMPORTED_MODULE_0_kompo___default.a.getProps(table),
            selector = tableProps.rowClass ? '.' + tableProps.rowClass : 'tr';

        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_kompo_util__["delegate"])(table, selector, 'click', function (e) {
            __WEBPACK_IMPORTED_MODULE_0_kompo__["state"].dispatch(this, function (s) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_kompo_util__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_kompo_util___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_kompo_util__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_js_table_table__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_js_table_accordionTable__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__src_js_table_selectTable__ = __webpack_require__(52);
...
var root = __WEBPACK_IMPORTED_MODULE_0_kompo___default.a.construct('div', function (_ref) {
    ...
    var addLimit = doc.createElement('a'),
        ...
        t2 = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__src_js_table_selectTable__["a" /* default */])({
        ...
        rowFilter: function rowFilter(data) {
        ...
        t3 = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__src_js_table_accordionTable__["a" /* default */])({
        showOne: false,
        columnFilter: function columnFilter(data) {
            return {
                Firstname: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_kompo_util__["capitalize"])(data.firstname),
    ...
    addLimit.addEventListener('click', function (e) {
        e.preventDefault();
        __WEBPACK_IMPORTED_MODULE_2__src_js_table_table__["b" /* tableActions */].addLimit(_this, 1);
    });

    subLimit.textContent = 'Subtract 1 of limit';
    subLimit.addEventListener('click', function (e) {
        e.preventDefault();
        __WEBPACK_IMPORTED_MODULE_2__src_js_table_table__["b" /* tableActions */].subLimit(_this, 1);
    });

    addOffset.textContent = 'Add 1 to offset';
    addOffset.addEventListener('click', function (e) {
        e.preventDefault();
        __WEBPACK_IMPORTED_MODULE_2__src_js_table_table__["b" /* tableActions */].addOffset(_this, 1);
    });

    subOffset.textContent = 'Subtract 1 of offset';
    subOffset.addEventListener('click', function (e) {
        e.preventDefault();
        __WEBPACK_IMPORTED_MODULE_2__src_js_table_table__["b" /* tableActions */].subOffset(_this, 1);
    });

    minimize.textContent = 'Minimize';
    minimize.addEventListener('click', function (e) {
        e.preventDefault();
        __WEBPACK_IMPORTED_MODULE_2__src_js_table_table__["b" /* tableActions */].minimize(_this);
    });
...
/* harmony default export */ __webpack_exports__["a"] = (__WEBPACK_IMPORTED_MODULE_0_kompo___default.a.construct('tr', function (_ref) {
    ...
    var defaultClass = _ref.defaultClass,
        rowSlot = _ref.rowSlot;

    if (defaultClass) this.classList.add(defaultClass);

    var c = this.appendChild(document.createElement('td'));
